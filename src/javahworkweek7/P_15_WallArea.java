...
public class P_15_WallArea {

    double height;
    double width;

    public P_15_WallArea(){

    }
    public P_15_WallArea(double width, double height){
        this.height = height;
        this.width = width;
    }
    ...
    public void setWidth(double width) {
        if (width < 0) {
            ...
            //System.out.println("Width field value to 0");
            this.width = width;
        ...
        public void setHeight(double height) {
            if (height < 0) {
                ...
                //System.out.println("height field value to 0");
                this.height=height;
    ...
    public static void main(String[] args) {
        P_15_WallArea wall =  new P_15_WallArea(5,4);
        System.out.println("area = "+  wall.getArea());
        wall.setHeight(-1.5);
        System.out.println("width= " + wall.getWidth());
        System.out.println("height ="+ wall.getHeight());
