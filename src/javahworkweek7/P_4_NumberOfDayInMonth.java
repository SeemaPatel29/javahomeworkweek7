...
public class P_4_NumberOfDayInMonth {
    ...
    public static void getDaysInMonths(int month, int year) {
        ...
        switch (month) {
            ...
            case 5:
                System.out.println("May months has 31 days");
                break;

            case 6:
                System.out.println("June months has 30 days");
                break;

            case 7:
                System.out.println("July months has 31 days");
                break;

            case 8:
                System.out.println("August months has 31 days");
                break;

            case 9:
                System.out.println("September months has 30 days");
                break;

            case 10:
                System.out.println("October months has 31 days");

                break;

            case 11:
                System.out.println("November months has 30 days");
                break;

            case 12:
                System.out.println("December months has 31 days");
                break;
